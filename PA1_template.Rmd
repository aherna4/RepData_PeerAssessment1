...
The mean is `r mean_`, and the median is `r median`.
...
From earlier, the mean and median of our data without replacing the missing values were `r mean_` and `r median`, respectively.

The differences between the means is `r new_mean - mean_` and the difference between the medians is `r new_median - median`. So, there is a slight difference on the median values, but no difference in the mean values.
